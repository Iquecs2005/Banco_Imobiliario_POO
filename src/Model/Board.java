...
class Board 
{
	...
	public Board(Bank bank) 
	{
	    ...
	    terrainsList.add(new Property("av_presidente_vargas", 60, 2, new House(50, 10), new Hotel(50, 250)));
	    terrainsList.add(new Property("av_nossa_sra_de_copacabana", 60, 4, new House(50, 20), new Hotel(50, 450)));
	    terrainsList.add(new Company("Trem", 200, 0, 25)); // Companhia Ferroviária
	    terrainsList.add(new Property("av_brigadero_faria_lima", 240, 20, new House(150, 100), new Hotel(150, 1100)));
	    terrainsList.add(new Company("Taxi", 150, 0, 40)); // Companhia de Viação
	    terrainsList.add(new Property("av_reboucas", 220, 15, new House(150, 75), new Hotel(150, 900)));
	    terrainsList.add(new Property("av_9_de_julho", 220, 18, new House(150, 90), new Hotel(150, 1050)));
	    terrainsList.add(jailSpace); // Prisão
	    terrainsList.add(new Property("av_europa", 200, 16, new House(100, 80), new Hotel(100, 1000)));
	    terrainsList.add(new LuckSpace()); // Sorte
	    terrainsList.add(new Property("rua_augusta", 180, 14, new House(100, 70), new Hotel(100, 950)));
	    terrainsList.add(new Property("av_pacaembu", 180, 14, new House(100, 70), new Hotel(100, 950)));
	    ...
	    terrainsList.add(new Property("av_brasil", 160, 12, new House(100, 60), new Hotel(100, 900)));
	    terrainsList.add(new LuckSpace()); // Sorte
	    terrainsList.add(new Property("av_paulista", 140, 10, new House(100, 50), new Hotel(100, 750)));
	    ...
	    terrainsList.add(new Property("av_vieira_souto", 320, 25, new House(200, 125), new Hotel(200, 1200)));
	    terrainsList.add(new Property("av_atlantica", 300, 26, new House(200, 130), new Hotel(200, 1275)));
	    terrainsList.add(new Property("Ipanema", 300, 26, new House(200, 130), new Hotel(200, 1275)));
	    terrainsList.add(new LuckSpace()); // Sorte
	    terrainsList.add(new Property("jardim_paulista", 280, 24, new House(150, 120), new Hotel(150, 1200)));
